exports.paymentSuccess = (amount, paymentId, orderId, name,lastname) => {
    ...
    <body>
        <div class="container">
            <a href="https://studynotion-edtech-project.vercel.app"><img class="logo" src="https://res.cloudinary.com/dx0ooqk4w/image/upload/v1745070965/techravibusiness/rq8fuwwiplbnn9v2713g.png"
                    alt="devcode Logo"></a>
            <div class="message">
